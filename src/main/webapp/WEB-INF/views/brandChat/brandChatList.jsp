...
<div id="chatbox">
   <div id="friendslist">
		...
		<div id="friends">
		    <c:if test="${not empty list}">
			    <c:forEach var="list" items="${list}">
			        <div class="friend" onclick="javascript:chatData('${list.sender}')">
			            <img src="https://i.ibb.co/XFs4D2M/go2go2.png" />
			            <p>
			                <strong>${list.sender}</strong><br>
    ...
    function chatData(receiver) {
		window.open('brandChat.do?receiver=' + receiver, "chatData",
